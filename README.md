...
|-------|---------|-------------|
| [opencode](charts/opencode) | 1.4.2 | Runs the OpenCode AI coding agent on Kubernetes as a StatefulSet, one persistent workspace per git repository. |
...
helm repo update
helm install opencode neomanexlabs/opencode --version 1.4.2
```
