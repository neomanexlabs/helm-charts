...
helm install opencode neomanexlabs/opencode --version 1.4.2 -f my-values.yaml
```

Or as an OCI artifact:

```sh
helm install opencode oci://ghcr.io/neomanexlabs/charts/opencode --version 1.4.2 -f my-values.yaml
```
